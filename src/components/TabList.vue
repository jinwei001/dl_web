<template>
  <div class="table">
    ...
    >
      <!--region 选择框-->
      <el-table-column v-if="options.mutiSelect" type="selection" width="60" align="center"></el-table-column>
      <el-table-column v-if="options.xh" type="index" label="序号" width="60" align="center" />
      <!--endregion-->
      <!--region 数据列-->
      <template v-for="(column, index) in columns">
        ...
        >
          <template slot-scope="scope">
            ...
            <template v-else>
              <el-row>
                <el-col :column="column" :row="scope.row" :render="column.render" :index="index"></el-col>
              </el-row>
            </template>
          </template>
        </el-table-column>
      ...
      <el-table-column
        ...
        v-if="operates.show?operates.list.filter(_x=>_x.show === true).length > 0:false"
      >
        <template slot-scope="scope">
