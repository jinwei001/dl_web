    ...
    draw: function draw(context, dataSet, options) {
      ...
      if (!enableCluster) {
        ...
        for (var _gridKey2 in grids) {
          ...
          context.beginPath()
          context.rect(_gridKey2[0] * size + 0.5 + offset.x, _gridKey2[1] * size + 0.5 + offset.y, size, size)
...
*/
  ...
  var ForceEdgeBundling = function ForceEdgeBundling() {
    ...
    var compatibility_list_for_edge = []
    var subdivision_points_for_edge = []
    var K = 0.1
    ...
    var I_rate = 0.6666667
    // rate at which iteration number decreases i.e. 2/3
    var compatibility_threshold = 0.6
    var invers_quadratic_mode = false
    var eps = 1e-8
  ...
  var MapVRenderer = (function(_BaseLayer) {
    ...
    createClass(MapVRenderer, [{
      ...
      value: function _canvasUpdate(time) {
        ...
        var resolutionY = dh / mapCanvas.y
      ...
      value: function _canvasUpdate(t) {
        ...
        if (this.canvasLayer && !this.stopAniamation) {
          ...
          if (this.isEnabledTime()) {
            ...
            this.context === '2d' && (n.save(), n.globalCompositeOperation = 'destination-out', n.fillStyle = 'rgba(0, 0, 0, .1)', n.fillRect(0, 0, n.canvas.width, n.canvas.height), n.restore())
          } else this.clear(n)
          if (this.context === '2d') {
          ...
          var a = {
            transferCoordinate: function transferCoordinate(t) {
              ...
              var n = Cesium.SceneTransforms.wgs84ToWindowCoordinates(e, i)
    ...
    var MapVLayer$1 = (function() {
      ...
      function MapVLayer(viewer, dataset, options, container) {
        ...
        if (container) {
          ...
          this.container = inner || viewer.container
        }
      ...
      createClass(MapVLayer, [{
        ...
        value: function _createCanvas() {
          ...
          return this.mapVOptions.context == '2d' && t.getContext(this.mapVOptions.context).scale(e, e), t
        }
      }, {
        key: '_reset',
        ...
        value: function resizeCanvas() {
          if (void 0 != this.canvas && this.canvas != null) {
            var t = this.canvas
