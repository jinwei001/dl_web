  ...
  <div class="main-body">
    ...
    <div class="content">
      <div class="record-operation">
        <el-button type="primary" size="small" @click="auditCaseBtn" class="onSearch">取消缺陷处置案例</el-button>
      </div>
      <el-table border stripe :data="tableData" style="border: 1px solid #c7c7c7" :cell-style="{borderColor: '#c7c7c7'}" :header-cell-style="{'background':'#e4ebf1',borderColor: '#c7c7c7'}" highlight-current-row @selection-change="CheckFun">
        ...
        <el-table-column fixed="right" label="操作" align="center">
          <template slot-scope="scope">
            <el-button class="onSearch" type="primary" size="mini" @click="checkDetailBtn(scope.row)">查看</el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    <div v-if="isShowDialog">
      <Add :selection='selection' @childFn="parentFn" :thisStatus='thisStatus' :thisDetail='thisDetail' />
    </div>
  </div>
</template>
<script>
...
import {
  ...
  getDy, // 电压
  getBz, // 发现班组
  cancelCase as auditCase, // 生成缺陷处置案例
  dyGetxl // 电压获取线路
} from '@/api/defect'
