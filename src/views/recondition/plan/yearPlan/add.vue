    ...
    >
      ...
      >
        ...
        <div class="Form-input">
          ...
          <el-form-item :label="`检修${$xl}：`" label-width="150px" prop="xlid" style="width: 50%;">
            <el-select
              v-model="form.xlid"
              clearable
              filterable
        ...
        <div class="Form-input">
          <el-form-item label="任务来源：" label-width="150px" prop="tasksource" style="width:50%">
            <el-select
        ...
        <div class="Form-input">
          ...
          <el-form-item label="是否停电：" label-width="150px" prop="ispowercut" style="width:50%">
            <el-select
              v-model="form.ispowercut"
              clearable
              placeholder="请选择"
              :disabled="isdisabled"
              @change="istd(form.ispowercut)"
            >
              <el-option
        ...
        <div class="Form-input">
          <el-form-item label="是否有送电方案：" label-width="150px" style="width:50%;line-height:20px">
            <el-select
  ...
  methods: {
    ...
    getList() {
      ...
      getData(this.$qs.stringify(this.form)).then(res => {
        ...
        console.log('this.form.devicetypename :>> ', this.form.devicetypename);
