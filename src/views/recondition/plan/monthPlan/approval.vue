    ...
    >
      ...
      >
        ...
        <div class="Form-input">
          ...
          <el-form-item label="停电范围：" label-width="150px" prop="gzxlid" style="width: 50%;">
        ...
        <div class="Form-input">
          ...
          <el-form-item label="计划开始时间：" label-width="150px" prop="gzxlid" >
            <el-input v-model="form.planstarttime" clearable :disabled="isdisabled" />
          </el-form-item>
          <el-form-item label="设备类型：" label-width="150px" prop="gzxlid" style="width: 50%;">
            <el-input v-model="form.devicetypename" :title="form.devicetypename" clearable :disabled="isdisabled" />
          </el-form-item>
        </div>
        <div class="Form-input">
        ...
        <div class="Form-input">
          ...
          <el-form-item label="复役要求：" label-width="150px" prop="gzxlid" >
...
import { getData, submitlc } from "@/api/recondition/monthPlan";
export default {
  props: {
    openId: "",
    status: ""
