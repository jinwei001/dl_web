...
import TractionTubeShow from "./traction-tube-show";
import {
  List,
  Add,
  DeleteList,
  Edit,
  downLoadFileName
} from "@/api/cableandchannel/channel-ledger-management/channel-ledger-management/cl-tractionTube";
export default {
  components: {
    Pagination,
    TractionTubeShow
  ...
  methods: {
    ...
    EditFn() {
      ...
      // this.$refs.TractionTubeShow.getEcho(this.openID) // 调用子页面方法
    },
    // 删除按钮
    deleteFn() {
