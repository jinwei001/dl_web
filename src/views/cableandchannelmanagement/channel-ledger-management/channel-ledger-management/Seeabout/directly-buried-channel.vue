<template>
  ...
  <div class="main-userSelect">
    ...
    <div v-if="isShowDialog">
      <directly-buried-show
        ref="DirectlyBuriedShow"
        @childFn="parentFn"
        :isEdit="isEdit"
        :openID="openID"
...
import DirectlyBuriedShow from "./directly-buried-channel-show";
import {
  List,
  Add,
  DeleteList,
...
export default {
  ...
  methods: {
    ...
    EditFn() {
      ...
      // this.$refs.DirectlyBuriedShow.getEcho(this.openID) // 调用子页面方法
    },
    // 删除按钮
    deleteFn() {
