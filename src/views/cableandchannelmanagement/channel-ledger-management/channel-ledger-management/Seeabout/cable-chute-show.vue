    ...
    >
      ...
      >
        <div class="Form-input">
          <div class="form-item">
            <label class="form-label">{{$dl}}沟ID：</label>
        ...
        <div class="Form-input">
          ...
          <div class="form-item">
            <label class="form-label">{{$dl}}沟名称：</label>
            <el-input v-model="form.dlgmc" clearable :readonly="isreadonly"/>
          </div>
        </div>
        <div class="Form-input">
          <div class="form-item">
            <label class="form-label">{{$dl}}沟编号：</label>
            <el-input v-model="form.dlgbh" clearable :readonly="isreadonly"/>
          </div>
          <div class="form-item">
        ...
        <div class="Form-input">
          ...
          <div class="form-item">
            ...
            <el-input v-model="form.dmcc" clearable :readonly="isreadonly"/>
          </div>
        </div>
        <div class="Form-input">
          <div class="form-item">
            <label class="form-label">{{$dl}}沟长度：</label>
            <el-input v-model="form.dlgcd" clearable :readonly="isreadonly"/>
          </div>
          <div class="form-item">
            <label class="form-label">{{$dl}}沟盖板数量：</label>
            <el-input v-model="form.dlggbsl" clearable :readonly="isreadonly"/>
          </div>
        </div>
        <div class="Form-input">
          <div class="form-item">
            <label class="form-label">盖板材质：</label>
            <el-input v-model="form.gbcz" clearable :readonly="isreadonly"/>
          </div>
          <div class="form-item">
...
import {
  ...
  DeleteList,
  Edit
} from "@/api/cableandchannel/channel-ledger-management/channel-ledger-management/cl-cablechute";
