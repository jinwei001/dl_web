<template>
  ...
  <div class="main-userSelect">
    ...
    <div v-if="isShowDialog">
      <level-pipe-jacking-show
        ref="LevelPipeJackingShow"
        @childFn="parentFn"
        :isEdit="isEdit"
        :openID="openID"
...
import LevelPipeJackingShow from "./level-of-pipe-jacking-show";
import {
  List,
  Add,
  DeleteList,
...
export default {
  ...
  methods: {
    ...
    EditFn() {
      ...
      // this.$refs.LevelPipeJackingShow.getEcho(this.openID) // 调用子页面方法
    },
    // 删除按钮
    deleteFn() {
