    ...
    >
      ...
      >
        <div class="Form-input">
          <div class="form-item">
            <label class="form-label">{{$dl}}竖井ID：</label>
        ...
        <div class="Form-input">
          ...
          <div class="form-item">
            <label class="form-long-label">是否井深埋：</label>
...
import {
  ...
  DeleteList,
  Edit
} from "@/api/cableandchannel/channel-ledger-management/channel-ledger-management/cl-cableShaft";
