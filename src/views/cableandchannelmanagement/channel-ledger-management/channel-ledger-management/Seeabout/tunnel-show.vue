      ...
      >
        ...
        <div class="Form-input">
          ...
          <div class="form-item">
            ...
            <el-input v-model="form.sdmc" clearable :readonly="isreadonly"/>
          </div>
        </div>
        <div class="Form-input">
          <div class="form-item">
            <label class="form-label">隧道编号：</label>
            <el-input v-model="form.sdbh" clearable :readonly="isreadonly"/>
          </div>
          <div class="form-item">
            <label class="form-label">所属通道：</label>
            <el-input v-model="form.tdmc" disabled/>
          </div>
        </div>
        <div class="Form-input">
          <div class="form-item">
        ...
        <div class="Form-input">
          ...
          <div class="form-item">
            <label class="form-label">隧道长度：</label>
            <el-input v-model="form.sdcd" clearable :readonly="isreadonly"/>
          </div>
        </div>
        <div class="Form-input">
          <div class="form-item">
...
import {
  ...
  DeleteList,
  Edit
} from "@/api/cableandchannel/channel-ledger-management/channel-ledger-management/cl-tunnel";
  ...
  created() {
    if (this.isAdd == true){
      ...
      fatherList(this.$qs.stringify(this.formParam)).then(res => {
        //console.log(res);
        this.form.tdmc = res.data.rows[0].sdmc
      });
    } else {
      // 编辑回显
