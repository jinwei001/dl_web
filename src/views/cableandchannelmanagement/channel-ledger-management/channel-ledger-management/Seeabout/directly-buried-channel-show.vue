      ...
      >
        ...
        <div class="Form-input">
          <div class="form-item">
            ...
            <el-input v-model="form.tdbh" clearable :readonly="isreadonly" />
          </div>
          <div class="form-item">
        ...
        <div class="Form-input">
          <div class="form-item">
            ...
            <el-input v-model="form.tdlx" clearable :readonly="isreadonly" />
          </div>
          <div class="form-item">
        ...
        <div class="Form-input">
          ...
          <div class="form-item">
            ...
            <el-input v-model="form.tdcd" clearable :readonly="isreadonly" />
          </div>
        </div>
        <div class="Form-input">
          <div class="form-item">
...
import {
  ...
  DeleteList,
  Edit
} from "@/api/cableandchannel/channel-ledger-management/channel-ledger-management/cl-DBChannel";
