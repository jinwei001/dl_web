    ...
    >
      ...
      >
        <div class="Form-input">
          <div class="form-item">
            <label class="form-label">综合管廊ID：</label>
        ...
        <div class="Form-input">
          ...
          <div class="form-item">
            <label class="form-label">综合管廊名称：</label>
            <el-input v-model="form.zhglmc" clearable :readonly="isreadonly"/>
          </div>
        </div>
        <div class="Form-input">
          <div class="form-item">
            <label class="form-label">综合管廊编号：</label>
            <el-input v-model="form.zhglbh" clearable :readonly="isreadonly"/>
          </div>
          <div class="form-item">
        ...
        <div class="Form-input">
          ...
          <div class="form-item">
            ...
            <el-input v-model="form.yxzt" clearable :readonly="isreadonly"/>
          </div>
        </div>
        <div class="Form-input">
          <div class="form-item">
        ...
        <div class="Form-input">
          ...
          <div class="form-item">
            ...
            <el-input v-model="form.jgxs" clearable :readonly="isreadonly"/>
          </div>
        </div>
        <div class="Form-input">
          <div class="form-item">
            <label class="form-label">悬挂方式：</label>
            <el-input v-model="form.xgfs" clearable :readonly="isreadonly"/>
          </div>
          <div class="form-item">
        ...
        <div class="Form-input">
          ...
          <div class="form-item">
            <label class="form-label">综合管廊长度：</label>
            <el-input v-model="form.zhglcd" clearable :readonly="isreadonly"/>
          </div>
        </div>
        <div class="Form-input">
          <div class="form-item">
...
import {
  ...
  DeleteList,
  Edit
} from "@/api/cableandchannel/channel-ledger-management/channel-ledger-management/cl-utilityTunnel";
