      ...
      >
        ...
        <div class="Form-input">
          <div class="form-item">
            ...
            <el-input v-model="form.sssd" clearable :readonly="isreadonly" />
          </div>
          <div class="form-item">
        ...
        <div class="Form-input">
          <div class="form-item">
            ...
            <el-input v-model="form.mxz" clearable :readonly="isreadonly" />
          </div>
          <div class="form-item">
            <label class="form-label">门尺寸：</label>
            <el-input v-model="form.mcc" clearable :readonly="isreadonly" />
          </div>
        </div>
        <div class="Form-input">
          <div class="form-item">
            <label class="form-label">门材质：</label>
            <el-input v-model="form.mcz" clearable :readonly="isreadonly" />
          </div>
          <div class="form-item">
            <label class="form-label">门生产厂家：</label>
            <el-input v-model="form.msccj" clearable :readonly="isreadonly" />
          </div>
        </div>
        <div class="Form-input">
          <div class="form-item">
            <label class="form-label">门出厂日期：</label>
            <!--<el-input v-model="form.mccrq" clearable :readonly="isreadonly" />-->
            <el-col>
              <el-date-picker
                style="width: 100%;"
                v-model="form.mccrq"
