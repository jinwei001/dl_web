      ...
      >
        ...
        <div class="Form-input">
          ...
          <div class="form-item">
            ...
            <el-input v-model="form.tfkbh" clearable :readonly="isreadonly" />
          </div>
        </div>
        <div class="Form-input">
          <div class="form-item">
        ...
        <div class="Form-input">
          ...
          <div class="form-item">
            ...
            <el-input v-model="form.sspgdlgsd" clearable :readonly="isreadonly" />
          </div>
        </div>
        <div class="Form-input">
          <div class="form-item">
            <label class="form-long-label">所属排管/{{$dl}}沟/&ensp;隧道类型：</label>
            <el-input v-model="form.sspgdlgsdlx" clearable :readonly="isreadonly" />
          </div>
          <div class="form-item">
        ...
        <div class="Form-input">
          <div class="form-item">
            ...
            <el-input v-model="form.ggcc" clearable :readonly="isreadonly" />
          </div>
          <div class="form-item">
