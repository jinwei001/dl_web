  ...
  <div class="hastitle">
    ...
    >
      ...
      >
        ...
        <div class="Form-input">
          <div class="form-item">
            <label class="form-long-label">实物ID{{$dl}}终端&ensp;站ID：</label>
        ...
        <div class="Form-input">
          ...
          <div class="form-item">
            <label class="form-label">{{$dl}}终端站名称：</label>
            <el-input v-model="form.dlzdzmc" clearable :readonly="isreadonly" />
          </div>
        </div>
        <div class="Form-input">
          <div class="form-item">
            <label class="form-label">{{$dl}}终端站编号：</label>
            <el-input v-model="form.dlzdzbh" clearable :readonly="isreadonly" />
          </div>
          <div class="form-item">
            <label class="form-label">地理位置描述：</label>
            <el-input v-model="form.dlwzms" clearable :readonly="isreadonly" />
          </div>
        </div>
        <div class="Form-input">
          <div class="form-item">
...
import {
  ...
  DeleteList,
  Edit
} from "@/api/cableandchannel/channel-ledger-management/accessAccessory/cable-terminal";
