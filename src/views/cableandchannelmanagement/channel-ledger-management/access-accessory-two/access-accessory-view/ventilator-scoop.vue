<template>
  ...
  <div class="main-userSelect main-body">
    ...
    <div v-if="isShowDialog">
      <ventilator-scoop-show
        ref="VentilatorScoopShow"
        @childFn="parentFn"
        :isEdit="isEdit"
        :openID="openID"
...
import VentilatorScoopShow from "./ventilator-scoop-show";
import {
  List,
  Add,
  DeleteList,
...
export default {
  ...
  methods: {
    ...
    EditFn() {
      ...
      this.$refs.VentilatorScoopShow.getEcho(this.openID); // 调用子页面方法
    },
    // 删除按钮
    deleteFn() {
