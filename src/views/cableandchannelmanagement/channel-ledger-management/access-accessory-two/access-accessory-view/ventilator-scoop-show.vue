  ...
  <div class="hastitle">
    ...
    >
      ...
      >
        ...
        <div class="Form-input">
          <div class="form-item">
            <label class="form-label">通风口ID：</label>
        ...
        <div class="Form-input">
          ...
          <div class="form-item">
            <label class="form-label">通风口编号：</label>
            <el-input v-model="form.tfkbh" clearable :disabled="isdisabled" />
          </div>
        </div>
        <div class="Form-input">
          <div class="form-item">
        ...
        <div class="Form-input">
          ...
          <div class="form-item">
            <label class="form-long-label">所属排管/{{$dl}}沟/&ensp;隧道：</label>
            <el-input v-model="form.sspgdlgsd" clearable :disabled="isdisabled" />
          </div>
        </div>
        <div class="Form-input">
          <div class="form-item">
            <label class="form-long-label">所属排管/{{$dl}}沟/&ensp;隧道类型：</label>
            <el-input v-model="form.sspgdlgsdlx" clearable :disabled="isdisabled" />
          </div>
          <div class="form-item">
        ...
        <div class="Form-input">
          <div class="form-item">
            ...
            <el-input v-model="form.ggcc" clearable :disabled="isdisabled" />
          </div>
          <div class="form-item">
...
import {
  ...
  DeleteList,
  Edit
} from "@/api/cableandchannel/channel-ledger-management/accessAccessory/ventilator-scoop";
