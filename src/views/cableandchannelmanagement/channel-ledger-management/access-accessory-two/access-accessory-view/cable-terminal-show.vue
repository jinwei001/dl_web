      ...
      >
        ...
        <div class="Form-input">
          ...
          <div class="form-item">
            ...
            <el-input v-model="form.dlzdzmc" clearable :disabled="isdisabled" />
          </div>
        </div>
        <div class="Form-input">
          <div class="form-item">
            <label class="form-label">{{$dl}}终端站编号：</label>
            <el-input v-model="form.dlzdzbh" clearable :disabled="isdisabled" />
          </div>
          <div class="form-item">
            <label class="form-label">地理位置描述：</label>
            <el-input v-model="form.dlwzms" clearable :disabled="isdisabled" />
          </div>
        </div>
        <div class="Form-input">
