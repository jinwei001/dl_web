<template>
  ...
  <div class="main-userSelect main-body">
    ...
    <div v-if="isShowDialog">
      <check-well-work-wall
        ref="CheckWellWorkWall"
        @childFn="parentFn"
        :isEdit="isEdit"
        :openID="openID"
...
import CheckWellWorkWall from "./check-well-or-work-well-show";
import {
  List,
  Add,
  DeleteList,
...
export default {
  ...
  methods: {
    ...
    EditFn() {
      ...
      // this.$refs.CheckWellWorkWall.getEcho(this.openID) // 调用子页面方法
    },
    // 删除按钮
    deleteFn() {
