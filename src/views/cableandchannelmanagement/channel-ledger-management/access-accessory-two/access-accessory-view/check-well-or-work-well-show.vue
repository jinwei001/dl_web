      ...
      >
        ...
        <div class="Form-input">
          ...
          <div class="form-item">
            ...
            <el-input v-model="form.sfjsm" clearable :disabled="isdisabled" />
          </div>
        </div>
        <div class="Form-input">
          <div class="form-item">
        ...
        <div class="Form-input">
          ...
          <div class="form-item">
            ...
            <el-input v-model="form.sssdpg" clearable :disabled="isdisabled" />
          </div>
        </div>
        <div class="Form-input">
          <div class="form-item">
            <label class="form-long-label">所属隧道/排管类&ensp;型：</label>
            <el-input v-model="form.sssdpglx" clearable :disabled="isdisabled" />
          </div>
          <div class="form-item">
        ...
        <div class="Form-input">
          ...
          <div class="form-item">
            ...
            <el-input v-model="form.jmgc" clearable :disabled="isdisabled" />
          </div>
        </div>
        <div class="Form-input">
          <div class="form-item">
            <label class="form-label">内底高程：</label>
            <el-input v-model="form.ndgc" clearable :disabled="isdisabled" />
          </div>
          <div class="form-item">
            <label class="form-label">井尺寸：</label>
            <el-input v-model="form.jcc" clearable :disabled="isdisabled" />
          </div>
        </div>
        <div class="Form-input">
          <div class="form-item">
            <label class="form-label">井盖形状：</label>
            <el-input v-model="form.jgxz" clearable :disabled="isdisabled" />
          </div>
          <div class="form-item">
            <label class="form-label">井盖材质：</label>
            <el-input v-model="form.jgcz" clearable :disabled="isdisabled" />
          </div>
        </div>
        <div class="Form-input">
          <div class="form-item">
            <label class="form-label">井盖生产厂家：</label>
            <el-input v-model="form.jgsccj" clearable :disabled="isdisabled" />
          </div>
          <div class="form-item">
            <label class="form-label">井盖出厂日期：</label>
            <!--<el-input v-model="form.jgccrq" clearable :disabled="isdisabled" />-->
            <el-col>
              <el-date-picker
                style="width: 100%;"
                v-model="form.jgccrq"
        ...
        <div class="Form-input">
          ...
          <div class="form-item">
            ...
            <el-input v-model="form.sgdw" clearable :disabled="isdisabled" />
          </div>
        </div>
        <div class="Form-input">
          <div class="form-item">
