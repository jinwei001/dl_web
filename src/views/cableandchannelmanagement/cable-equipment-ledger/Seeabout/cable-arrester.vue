    ...
    <div class="searchForm_glf" v-if="zhpjHideButtomStatus">
      <el-form ref="form" inline>
        <el-form-item label="厂家：">
          <el-input v-model="form.sccj" clearable />
        </el-form-item>
        <el-form-item label="型号：">
          <el-input v-model="form.xh" clearable />
        </el-form-item>
    ...
    <div class="content" ref='contentref'>
      ...
      <div class="table">
        ...
        >
          ...
          <el-table-column prop="gtmc" :label="`所属${$gt}`" align="center"></el-table-column>
          <el-table-column prop="xh" label="设备型号" align="center"></el-table-column>
...
import CableArresterShow from "./cable-arrester-show";
import qs from "qs"
import {
  List,
  Add,
...
export default {
  ...
  methods: {
    ...
    view(val) {
      ...
      this.openID = val;
      this.isEdit = false;
      // this.$refs.cableArresterShow.getEcho(this.openID) // 调用子页面方法
    },
    /**编辑按钮 */
    EditFn() {
      if (
    ...
    // 导出功能
    exportData() {
      downLoadFileName(qs.stringify(this.form)).then(response => {
