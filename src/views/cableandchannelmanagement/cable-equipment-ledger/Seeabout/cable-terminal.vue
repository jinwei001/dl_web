    ...
    <div class="content" ref='contentref'>
      ...
      <div class="table">
        ...
        >
          ...
          <el-table-column prop="installationPosition" label="安装位置" align="center"></el-table-column>
          ...
          <el-table-column prop="producer" label="制作人" align="center"></el-table-column>
...
import CableTerminalShow from "./cable-terminal-show";
import {
  List,
  Add,
  DeleteList,
  Edit,
  downLoadFileName
} from "@/api/cableandchannel/cable-equipment-ledger/Line/cableterminal";
import  qs from  "qs"
export default {
  ...
  methods: {
    ...
    view(val) {
      ...
      this.openID = val;
      this.isEdit = false;
      // this.$refs.cableTerminalShow.getEcho(this.openID) // 调用子页面方法
    },
    /**编辑按钮 */
    EditFn() {
      if (
