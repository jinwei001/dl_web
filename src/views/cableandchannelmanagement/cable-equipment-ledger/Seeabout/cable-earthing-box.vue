<template>
  ...
  <div class="main-userSelect">
    ...
    <div class="content" ref='contentref'>
      ...
      <div class="table">
        ...
        >
          ...
          <el-table-column prop="zh" label="组号" align="center"></el-table-column>
          ...
          <el-table-column prop="xedy" :label="`额定电压（${$qf}）`" align="center"></el-table-column>
          <el-table-column prop="xedl" label="额定电流（A）" align="center"></el-table-column>
    ...
    <div v-if="isShowDialog">
      <cable-earthing-box-show
        ref="cableEarthingBoxShow"
        @childFn="parentFn"
        :isEdit="isEdit"
        :openID="openID"
...
import CableEarthingBoxShow from "./cable-earthing-box-show";
import {
  List,
  Add,
  DeleteList,
...
export default {
  ...
  methods: {
    ...
    view(val) {
      ...
      this.openID = val;
      this.isEdit = false;
      // this.$refs.cableEarthingBoxShow.getEcho(this.openID) // 调用子页面方法
    },
    /**编辑按钮 */
    EditFn() {
      if (
