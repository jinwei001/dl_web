    ...
    <div class="searchForm_glf" v-if="zhpjHideButtomStatus">
      <el-form ref="form" inline @submit.native.prevent>
        <el-form-item label="设备名称：">
            <el-input v-model="form.physicalCableStageName"  clearable/>
        </el-form-item>
    ...
    <div class="content" ref='contentref'>
      ...
      <div class="table">
        ...
        >
          ...
          <el-table-column prop="physicalCableStageName" label="设备名称" align="center"></el-table-column>
          <el-table-column prop="logicCableName" :label="`所属${$dl}`" align="center"></el-table-column>
          ...
          <el-table-column prop="length" label="长度（m）" align="center"></el-table-column>
...
import CableSectionShow from "./cable-section-show";
import {
  List,
  Add,
  DeleteList,
...
export default {
  ...
  methods: {
    ...
    AddNewFn() {
      ...
      // this.$refs.cableSectionShow.getCableList(this.form)
    },
    /**查看按钮 */
    view(val) {
      //console.log(val);
      ...
      this.openID = val;
      this.isEdit = false;
      // this.$refs.cableSectionShow.getEcho(this.openID) // 调用子页面方法
    },
    /**编辑按钮 */
    EditFn() {
      if (
