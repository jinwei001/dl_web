    ...
    <div class="searchForm_glf" v-if="zhpjHideButtomStatus">
      <el-form ref="form" inline @submit.native.prevent>
        <el-form-item label="设备名称：" >
          <el-input v-model="form.logicCableStageName" clearable />
        </el-form-item>
    ...
    <div class="content" ref='contentref'>
      ...
      <div class="table">
        ...
        >
          ...
          <el-table-column prop="logicCableStageName" label="设备名称" align="center"></el-table-column>
          <el-table-column prop="logicCableStageType" label="设备状态" align="center"></el-table-column>
          <el-table-column prop="voltageRank" :label="`${$dydj}`" align="center"></el-table-column>
          <el-table-column prop="phase" :label="`${$xb}`"  align="center"></el-table-column>
          <el-table-column prop="cableType" :label="`${$dl}类型`"  align="center"></el-table-column>
          <el-table-column prop="cableCount" :label="`${$dl}总长`" align="center"></el-table-column>
...
import CableShow from "./cable-show";
import {
  List,
  Add,
  DeleteList,
...
export default {
  ...
  methods: {
    ...
    view(val) {
      ...
      this.openID = val;
      this.isEdit = false;
      // this.$refs.cableShow.getEcho(this.openID) // 调用子页面方法
    },
    /**编辑按钮 */
    EditFn() {
      if (
