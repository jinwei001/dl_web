<template>
  ...
  <div class="main-userSelect">
    ...
    <div class="content" ref='contentref'>
        ...
        <el-form>
          <el-col>
            <el-form-item style="float: left;">
              <el-button class="onSearch" @click="AddNewFn" v-if="zhpjHideButtomStatus">
      ...
      <div class="table">
        ...
        >
          ...
          <el-table-column prop="azwz" label="安装位置" align="center"></el-table-column>
          ...
          <el-table-column prop="eddy" :label="`限额电压（${$qf}）`" align="center"></el-table-column>
          <el-table-column prop="eddl" label="限额电流（A）" align="center"></el-table-column>
    ...
    <div v-if="isShowDialog">
      <cable-cross-connection-box-show
        ref="cableCrossConShow"
        @childFn="parentFn"
        :isEdit="isEdit"
        :openID="openID"
...
import CableCrossConnectionBoxShow from "./cable-cross-connection-box-show";
import {
  List,
  Add,
  DeleteList,
...
export default {
  ...
  methods: {
    ...
    AddNewFn() {
      ...
      this.gruClickID = this.childclickID;
    },
    /**查看按钮 */
    view(val) {
      //console.log(val);
      ...
      this.openID = val;
      this.isEdit = false;
      // this.$refs.cableCrossConShow.getEcho(this.openID) // 调用子页面方法
    },
    /**编辑按钮 */
    EditFn() {
      if (
