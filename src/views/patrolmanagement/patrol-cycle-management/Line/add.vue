<template>
  ...
  <div class="hastitle">
    <el-dialog :visible.sync="showDialog" :title="`${$xl}巡视周期管理`" v-dialogDrag :center="true" :before-close="handleClose">
      ...
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="120px" class="required-ruleForm">
        ...
        <el-form-item label="上次巡视时间：" prop="scxssj">
          <el-date-picker v-model="ruleForm.scxssj" type="date" placeholder="选择日期时间" value-format='yyyy-MM-dd'>
          </el-date-picker>
        </el-form-item>
      ...
      <el-form ref="dataForm" :model="form" label-position="left" style="width:100% ;margin: 0 auto;">
        <el-card class="tz-box-card">
          <div v-if="!isEdit">
            <div class="Form-title-xs">{{$xl}}查询</div>

            <div class="Form-input">
              <div class="form-item">
                <label class="form-label">{{$dydj}}:</label>
                <el-select v-model="form.voltageRank" clearable placeholder="请选择">
                  <el-option v-for="item in selection.voltagesArr" :key="item.kv" :label="item.kv" :value="item.kv"></el-option>
                </el-select>
              </div>
              <div class="form-item">
            ...
            <div class="Form-input">
              <div class="form-item">
                ...
                <el-select v-model="form.lineRank" clearable placeholder="请选择">
              ...
              <div class="form-item">
                ...
                <el-input v-model="form.facilityMasterId"></el-input>
              </div>
            </div>
          ...
          <div class="table">
            <div class="table">
              <el-table :data="tableData" style="border: 1px solid #c7c7c7" height="200" :cell-style="{borderColor: '#c7c7c7'}" :header-cell-style="{'background':'#cddce6',borderColor: '#c7c7c7'}" border fit highlight-current-row @selection-change="CheckFun">
                ...
                <el-table-column prop="voltageRank" :label="`${$dydj}`"></el-table-column>
                <el-table-column prop="lineName" :label="`${$xl}名称`"></el-table-column>
                <el-table-column prop="groupId" label="运维班组"></el-table-column>
                <el-table-column prop="facilityMasterId" label="设备主人"></el-table-column>
                <el-table-column prop="runStatus" label="设备状态"></el-table-column>
                <el-table-column prop="lineRank" :label="`${$xl}等级`"></el-table-column>
              </el-table>
...
<script>
import {
  PatrolCycleManagementAdd as add,
  PatrolCycleManagementEdit as edit,
  PatrolCycleManagementLineDetail as detail,
  lineDetail
