      ...
      <div class="searchForm_glf">
        <el-form ref="form" inline>
          ...
          <el-form-item label="巡视人:">
            <el-select v-model="form.xsrId" clearable placeholder="请选择">
              <el-option
    ...
    <div class="content">
      ...
      <div class="table">
        ...
        >
          ...
          <el-table-column label="通道名称" align="center" prop="sdmc"></el-table-column>
          ...
          <el-table-column label="巡视人" align="center" prop="name"></el-table-column>
...
import {
  PatrolPlanChannerList as list,
  PatrolPlanDel as delData,
  channels,
  groups,
  users,
  cables, // dl
...
export default {
  ...
  methods: {
    ...
    upload() {
      ...
      this.searchForm.tdjhids = idsArr.join(",");
      ...
      planChannelsUpload(this.searchForm).then(res => {
