        ...
        <el-form>
          <el-col>
            <el-form-item style="float: left;">
              ...
              <el-button type="danger" plain @click="DelAllFn" v-if="shangchuArry.length>0" size="small">
                <i class="el-icon-close"></i> 删除
              </el-button>
<!--              <el-button class="onSearch" @click="shangchengfun" v-if="shangchuArry.length>0" size="small">
                <i class="el-icon-plus"> 生成巡视检测计划</i>
              </el-button> -->
              <el-button type="primary" @click="upload" v-if="shangchuArry.length>0" size="small">导出巡视记录</el-button>
      ...
      <div class="table">
        <el-table :data="tableData" height="600" style="border: 1px solid #c7c7c7;width:100%" :cell-style="{borderColor: '#c7c7c7'}"
         ...
         <!-- //XL名称 -->
          ...
          <!-- <el-table-column :label="`${$xl}`" align="center" prop="physicalName" width="200" show-overflow-tooltip></el-table-column> -->
          ...
          <!-- //DYDJ -->
          <el-table-column :label="$dydj+'等级'" align="center" prop="voltageRank"></el-table-column>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      this.selection.linesArr =this.Taskidname.bdxl
      jcbzSelect().then(res => {
