    ...
    >
      ...
      >
        ...
        <div class="Form-input">
          <el-form-item prop="yj" style="width:100%">
            <div style="width: 100%;">
              ...
              <el-input v-model="addlist.yj" type="textarea" :rows="4" placeholder="请输入内容" />
            </div>
          </el-form-item>
        </div>
        <!-- -------------------------------------------数据输入------------------------------------------------ -->
        ...
        <div class="Form-input">
          ...
          <el-form-item label="电气施工类型：" prop="dqsglxid" label-width="130px" style="width:33%">
            <el-select
              v-model="addlist.dqsglxid"
              placeholder="请输入电气施工类型："
              @change="chooseTDlx"
              filterable
              multiple
              style="width:100%"
        ...
        <div class="Form-input">
          <el-form-item :label="`${$dl}厂家：`" prop="dlcj" label-width="130px" style="width:33%">
            <el-input v-model="addlist.dlcj" clearable />
          </el-form-item>
          <el-form-item :label="`${$dl}型号：`" prop="dlxh" label-width="130px" style="width:33%">
            <el-input v-model="addlist.dlxh" clearable />
          </el-form-item>
          <el-form-item label="接头厂家：" prop="jtcj" label-width="130px" style="width:33%">
            <el-input v-model="addlist.jtcj" clearable />
          </el-form-item>
        </div>

        <div class="Form-input">
          <el-form-item label="接头型号：" prop="jtxh" label-width="130px" style="width:33%">
            <el-input v-model="addlist.jtxh" clearable />
          </el-form-item>
          <el-form-item label="终端厂家：" prop="zdcj" label-width="130px" style="width:33%">
            <el-input v-model="addlist.zdcj" clearable />
          </el-form-item>
          <el-form-item label="终端型号：" prop="zdxh" label-width="130px" style="width:33%">
            <el-input v-model="addlist.zdxh" clearable />
          </el-form-item>
        </div>

        <div class="Form-input">
          <el-form-item label="避雷器厂家：" prop="blqcj" label-width="130px" style="width:33%">
            <el-input v-model="addlist.blqcj" clearable />
          </el-form-item>
          <el-form-item label="避雷器型号：" prop="blqxh" label-width="130px" style="width:33%">
            <el-input v-model="addlist.blqxh" clearable />
          </el-form-item>
          <el-form-item label="附属设备厂家：" prop="fssbcj" label-width="130px" style="width:33%">
            <el-input v-model="addlist.fssbcj" clearable />
          </el-form-item>
        </div>

        <div class="Form-input">
          <el-form-item :label="`验收${$dl}敷设段：`" prop="ysdlfsd" label-width="180px" style="width:50%">
            <el-input v-model="addlist.ysdlfsd" clearable />
          </el-form-item>
          <el-form-item :label="`验收${$dl}附件位置：`" prop="ysdlfj" label-width="180px" style="width:50%">
            <el-input v-model="addlist.ysdlfj" clearable />
          </el-form-item>
        </div>

        <div class="Form-input">
          <!-- <el-form-item label="负责班组：" prop="fzbzid" label-width="130px" style="width:33%">
            <el-select v-model="addlist.fzbzid" placeholder="请选择">
              <el-option
                v-for="item in group"
                :key="item.objId"
          ...
          <el-form-item label="负责班组：" prop="fzbz" label-width="130px" style="width:33%">
            <el-select
          ...
          <el-form-item label="中间验收人员：" label-width="130px" style="width:33%">
            <el-input v-model="addlist.zjysry" clearable />
          </el-form-item>
        </div>
        <div class="Form-input">
          <el-form-item label="竣工验收时间：" label-width="180px" style="width:50%">
            <el-date-picker
              v-model="addlist.jgyssj"
              clearable
              type="date"
              placeholder="选择日期"
          ...
          <el-form-item :label="`终端${$ta}形式：`" prop="zdtxs" label-width="180px" style="width:50%">
            <el-select
              v-model="addlist.zdtxsmc"
              placeholder="请选择"
              value-key="bzmc"
              @change="choosezdtxs"
              clearable
        ...
        >
          ...
          <el-table-column type="index" label="序号" width="60" align="center" />
          <el-table-column prop="xm" label="项目" align="center">
            <template slot-scope="scope">
              <el-input v-model="scope.row.xm" clearable placeholder="请输入内容" />
            </template>
          </el-table-column>
          <el-table-column prop="gymc" label="工艺名称" align="center">
            <template slot-scope="scope">
...
export default {
  ...
  data() {
    return {
      ...
      //   dlcj: [{ required: true, message: "请输入"+this.$dl+"厂家", trigger: "blur" }],
      //   dlxh: [{ required: true, message: "请输入"+this.$dl+"型号", trigger: "blur" }],
      //   jtcj: [{ required: true, message: "请输入接头厂家", trigger: "blur" }],
      //   jtxh: [{ required: true, message: "请输入接头型号", trigger: "blur" }],
      //   zdcj: [{ required: true, message: "请输入终端厂家", trigger: "blur" }],
      //   zdxh: [{ required: true, message: "请输入终端型号", trigger: "blur" }],
      //   blqcj: [
      //     { required: true, message: "请输入避雷器厂家", trigger: "blur" }
      //   ],
      //   blqxh: [
      //     { required: true, message: "请输入避雷器型号", trigger: "blur" }
      //   ],
      //   fssbcj: [
      //     { required: true, message: "请输入附属设备厂家", trigger: "blur" }
      //   ],
      //   ysdlfsd: [
      //     { required: true, message: "请输入验收"+this.$dl+"敷设段", trigger: "blur" }
      //   ],
      //   ysdlfj: [
      //     { required: true, message: "请输入验收"+this.$dl+"附件位置", trigger: "blur" }
      //   ],
      //   dqsglxid: [
      //     {
      //       required: true,
      ...
      //   ],
      //   zdtxs: [
      //     { required: true, message: "请选择终端"+this.$ta+"形式", trigger: "change" }
      //   ]
      // },
      wjmc: null,
      wjlj: null,
  ...
  created() {
    ...
    //获取通道建设类型
    BzsjList("SCZBYS_DQSG_DQSGLX").then(res => {
      //console.log(res);
      this.options = res.data.data;
    });
    BzsjList("TERMINAL_TOWER_TYPE").then(res => {
      // //console.log(res);
      this.zoptions = res.data.data;
    });
    /**获取班组列表 */
    GropList().then(res => {
      if (res.status == 200) {
    ...
    if (this.isAdd) {
      ...
      /**获取页面数据 */
      dqys.getList(qs.stringify({ objId: this.sopenId })).then(res => {
        // //console.log(res);
        ...
        this.addlist.dqsglxid = data.dqsglxid.split(",");
        this.addlist.dlcj = data.dlcj;
        this.addlist.dlxh = data.dlxh;
        this.addlist.jtcj = data.jtcj;
        this.addlist.zdcj = data.zdcj;
        this.addlist.fzbz = data.fzbz;
        this.addlist.zdxh = data.zdxh;
        this.addlist.blqcj = data.blqcj;
        this.addlist.blqxh = data.blqxh;
        this.addlist.fzbzid = data.fzbzid;
        this.addlist.zjysry = data.zjysry;
        this.addlist.jgyssj = data.jgyssj;
        this.addlist.zdtxs = data.zdtxs;
        this.addlist.lczt = data.lczt;
        this.addlist.jtxh = data.jtxh;
        this.addlist.fssbcj = data.fssbcj;
        this.addlist.ysdlfsd = data.ysdlfsd;
        this.addlist.ysdlfj = data.ysdlfj;
        this.addlist.bzmc = data.bzmc;
        this.addlist.bzid = data.bzid;
      });
      info
        .BcyjList(qs.stringify({ dqsgid: this.sopenId, sgys: 2 }))
        .then(res => {
          // //console.log(res);
          this.bcyj = res.data.rows;
        });
      // info.LClist(qs.stringify({ dqsgid: this.sopenId, sgys: 2 })).then(res => {
      ...
      dqys.getList(qs.stringify({ objId: this.sopenId })).then(res => {
        ...
        (this.addlist.sftgcjd = data.sftgcjd),
          ...
          (this.addlist.ysdlfj = data.ysdlfj),
          (this.addlist.zdtxs = data.zdtxs),
          (this.addlist.zdtxsmc = data.zdtxsmc),
          (this.submitList.zdtxs = data.zdtxs),
          (this.submitList.zdtxsmc = data.zdtxsmc),
          (this.addlist.lczt = data.lczt);
        this.addlist.zjysry = data.zjysry;
        this.addlist.jtxh = data.jtxh;
        this.addlist.fssbcj = data.fssbcj;
      ...
      info.YjList(qs.stringify({ dqsgid: this.sopenId, sgys: 2 })).then(res => {
        //  GKK_more({ dqsgid: this.sopenId, sgys: 2 }).then(res => {
        // //console.log(res);
        // this.gkk_table_list = res.data.data;
      ...
      ExportFn(
        "/cable/tZjgcFj/list",
        qs.stringify({ zbid: this.sopenId, jd: 9 })
      )
        .then(res => {
  ...
  methods: {
    choosezdtxs(val) {
      this.addlist.zdtxsmc = val.bzmc;
      this.addlist.zdtxs = val.objId;
      this.submitList.zdtxsmc = val.bzmc;
      this.submitList.zdtxs = val.objId;
    },
    choosefzbz(val) {
    ...
    SuerFun() {
      this.$refs["formrules"].validate(val => {
        if (val) {
          ...
          //   "流程履历数据"
          // );
          this.addlist.dqsglxid = this.dqsglxid.toString();
          ...
          dqys.add(qs.stringify(this.addlist)).then(res => {
    ...
    submitFnQR() {
      ...
      (this.submitList.yj = this.addlist.yj),
        ...
        (this.submitList.dqsglxid = this.addlist.dqsglxid),
        (this.submitList.dlcj = this.addlist.dlcj),
        (this.submitList.dlxh = this.addlist.dlxh),
        (this.submitList.jtcj = this.addlist.jtcj),
        (this.submitList.jtxh = this.addlist.jtxh),
        (this.submitList.zdcj = this.addlist.zdcj),
        (this.submitList.fzbz = this.addlist.fzbz),
        (this.submitList.zdxh = this.addlist.zdxh),
        (this.submitList.blqcj = this.addlist.blqcj),
        (this.submitList.blqxh = this.addlist.blqxh),
        (this.submitList.fzbzid = this.addlist.fzbzid),
        (this.submitList.fssbcj = this.addlist.fssbcj),
        (this.submitList.ysdlfsd = this.addlist.ysdlfsd),
        (this.submitList.zjysry = this.addlist.zjysry),
        (this.submitList.jgyssj = this.addlist.jgyssj),
        (this.submitList.zdtxs = this.addlist.zdtxs),
      ...
      this.submitList.yj = this.addlist.yj;
      dqys.SubmitLc(qs.stringify(this.submitList)).then(res => {
        //console.log(res);
        this.tijiao = false;
    ...
    THFn() {
      ...
      //console.log("退回");
      dqys.SubmitLc(qs.stringify(thlist)).then(res => {
        this.showDialog = false;
        this.editbtn = false;
        this.$parent.getTableList();
        this.addbtn = false;
