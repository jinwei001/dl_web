    ...
    <div class="content">
      ...
      <div class="table">
        ...
        >
          ...
          <el-table-column prop="sjry" label="设计人员" align="center"></el-table-column>
          <el-table-column prop="sjtjch" label="设计图卷册号" align="center"></el-table-column>
          <el-table-column prop="ccscsj" label="初设审查时间" align="center"></el-table-column>
          <el-table-column prop="bzmc" label="审查班组" align="center"></el-table-column>
...
import FirstFoundedAdd from "./firstFounded-add";
import {
  getList,
  DeleteList
