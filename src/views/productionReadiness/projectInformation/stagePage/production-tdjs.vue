    ...
    <div class="content">
      ...
      <div class="table">
        ...
        >
          ...
          <el-table-column prop="tdjslxmc" label="通道建设类型" align="center"></el-table-column>
          <el-table-column prop="kgsj" label="开工时间" align="center">
            <template slot-scope="scope">
              <span>{{scope.row.kgsj | format('yyyy-MM-dd')}}</span>
            </template>
          </el-table-column>
...
import productionTdjsShow from "./production-tdjs-show";
import { getList } from "@/api/productionReadiness/projectInformation/production-tdjs";
