  ...
  <div class="main-body">
    <div class="main-userSelect">
      <div class="searchForm_glf">
        <el-form ref="ruleForm" inline>
          <el-form-item>
            <el-select v-model="ruleFrom.equipment" clearable placeholder="请选择">
              <el-option
                v-for="item in equipmentArr"
                :key="item.id"
                :label="item.hdposition"
                :value="item.hdposition"
              />
            </el-select>
          </el-form-item>
    ...
    <div class="content">
      <div class="leftWarp">
        ...
        >
          <el-table-column property="dianYaName" :show-overflow-tooltip="true" label="电压等级" />
          <el-table-column property="dianLanName" :show-overflow-tooltip="true" :label="`${$dl}名称`" />
          <el-table-column property="sheBeiName" :show-overflow-tooltip="true" label="设备名称" />
      ...
      <div class="allmapBox">
        ...
        <div v-if="dialogVisible" class="markerBox">
          <div class="detailTitle">
            <div class="titleType">{{ hiddenEquipment }}</div>
            <div class="guanbi" @click="handleClose">X</div>
          </div>
          <div class="detailContent">
            <div class="contentItem">隐患设备：{{ itemObj.sheBeiTypeName }}</div>
...
<script>
import { getHiddenType, getHiddenPageSize, getHiddenMapPoint } from '@/api/Sixdefensemanagement/hiddenDangerInfo.js'
...
export default {
  ...
  data() {
    return {
      ...
      hiddenEquipment: this.hiddenDangerEquipment,
      ruleFrom: {
        equipment: '',
        startTime: '',
        endTime: '',
      ...
      tableData: [],
      equipmentArr: [
        { id: 0, hdposition: '附件附属设备' },
        { id: 1, hdposition: '附属设施' },
        { id: 2, hdposition: this.$dl+'通道' },
        { id: 3, hdposition: this.$dl+'保护区内情况' },
        { id: 4, hdposition: '其他' }
      ],
      // 隐患图表list
      hiddenEchart: [],
  ...
  methods: {
    ...
    async onSearch() {
      ...
      var params = {
        ...
        hdposition: that.ruleFrom.equipment
      }
