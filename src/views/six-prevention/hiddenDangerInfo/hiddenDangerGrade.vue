  ...
  <div class="main-body">
    <div class="main-userSelect">
      <div class="searchForm_glf">
        <el-form ref="ruleForm" inline>
          <el-form-item>
            <el-select v-model="ruleFrom.Grade" clearable placeholder="请选择">
              <el-option
    ...
    <div class="content">
      <div class="leftWarp">
        ...
        >
          <el-table-column property="yinHuanDengJiName" :show-overflow-tooltip="true" label="隐患等级" />
          <el-table-column property="faXianFangShiName" :show-overflow-tooltip="true" label="隐患来源" />
          <el-table-column property="dangQianJieDianName" :show-overflow-tooltip="true" label="当前节点名称" />
      ...
      <div class="allmapBox">
        ...
        <div v-if="dialogVisible" class="markerBox">
          <div class="detailTitle">
            <div class="titleType">{{ hiddenGrade }}</div>
            <div class="guanbi" @click="handleClose">X</div>
          </div>
          <div class="detailContent">
            <div class="contentItem">隐患等级：{{ itemObj.yinHuanDengJiName }}</div>
...
export default {
  ...
  data() {
    return {
      ...
      hiddenGrade: this.hiddenDangerGrade,
      ruleFrom: {
        Grade: '',
        startTime: '',
        endTime: '',
