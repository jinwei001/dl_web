  ...
  <div class="main-body">
        ...
        <el-form ref="form" inline>
          <el-form-item :label="`${$xl}名称:`">
            <el-select v-model="form.dldj" clearable placeholder="请选择">
              <el-option v-for="item in selection.xlmc" :key="item.id" :label="item.qb" :value="item.id"></el-option>
            </el-select>
          </el-form-item>
    ...
    <div class="content">
      ...
      <div class="table">
        ...
        <pagination v-show="form.total>0" :total="form.total" :page.sync="form.pageNum" :limit.sync="form.limit" @pagination="getList" />
      </div>
    </div>
...
import { PatrolCycleManagementList as list } from '@/api/patrolmanagement'
export default {
  components: {
    Pagination
  },
